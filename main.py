...
name = "Jackie" 
date = "August 25"
favorite_movie = "The Sandlot"
print("Name:", name, "Date:", date, "Favorite_Movie:", favorite_movie) 
print(f"Hello {name}! Today's date is {date}. Your favorite movie is {favorite_movie}.") 

print("Name:\nJackie") 
print("Age:\n15") 
print(f"In 10 years, {name} will be {25} years old.")
